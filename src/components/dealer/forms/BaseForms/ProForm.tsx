...
import { createProProtocol, Pro } from "../../../../types/product/base";
...
export const ProForm = ({ setOpen }: { setOpen: React.Dispatch<React.SetStateAction<boolean>> }) => {

    console.log("In Pro form")
    ...
    const {
        ...
        resolver: zodResolver(createProProtocol(handrailKey)),
        mode: "onBlur",
        defaultValues: {
            handrail: null
        }
