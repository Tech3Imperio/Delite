...
import { createLuxProtocol, createProProtocol, createSemiMiniProtocol, createSemiProProtocol, createSemiSmartProtocol, Lux, Pro, SemiMini, SemiPro, SemiSmart } from "../../../../types/product/base";
...
export const LuxForm = ({ setOpen }: { setOpen: React.Dispatch<React.SetStateAction<boolean>> }) => {

    console.log("In Lux form")
    ...
    const {
        ...
        resolver: zodResolver(createLuxProtocol(handrailKey)),
        mode: "onBlur",
        defaultValues: {
            handrail: null
        }
