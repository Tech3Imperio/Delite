...
import { createMicroProtocol, createProProtocol, createSemiProProtocol, Micro, Pro, SemiPro } from "../../../../types/product/base";
...
export const MicroForm = ({ setOpen }: { setOpen: React.Dispatch<React.SetStateAction<boolean>> }) => {
    ...
    const {
        ...
        resolver: zodResolver(createMicroProtocol(handrailKey)),
        mode: "onBlur",
        defaultValues: {
            handrail: null
        }
