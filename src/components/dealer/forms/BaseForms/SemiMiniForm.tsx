...
import { createProProtocol, createSemiMiniProtocol, createSemiProProtocol, createSemiSmartProtocol, Pro, SemiMini, SemiPro, SemiSmart } from "../../../../types/product/base";
...
export const SemiMiniForm = ({ setOpen }: { setOpen: React.Dispatch<React.SetStateAction<boolean>> }) => {
    ...
    const {
        ...
        resolver: zodResolver(createSemiMiniProtocol(handrailKey)),
        mode: "onBlur",
        defaultValues: {
            handrail: null
        }
