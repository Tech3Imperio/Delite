...
import { createLuxProtocol, createProProtocol, createSemiMiniProtocol, createSemiProProtocol, createSemiSmartProtocol, createSpigotProtocol, Lux, Pro, SemiMini, SemiPro, SemiSmart, Spigot } from "../../../../types/product/base";
...
import { SelectSpigotSize } from "../../../../lib/SpigotSizeSelect";

export const SpigotForm = ({ setOpen }: { setOpen: React.Dispatch<React.SetStateAction<boolean>> }) => {

    console.log("In Spigot form")
    ...
    const {
        ...
        resolver: zodResolver(createSpigotProtocol(handrailKey)),
        mode: "onBlur",
        defaultValues: {
            handrail: null
        }
