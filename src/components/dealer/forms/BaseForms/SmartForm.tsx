...
import { createProProtocol, createSmartProtocol, Pro, Smart } from "../../../../types/product/base";
...
export const SmartForm = ({ setOpen }: { setOpen: React.Dispatch<React.SetStateAction<boolean>> }) => {

    console.log("In Smart form")
    ...
    const {
        ...
        resolver: zodResolver(createSmartProtocol(handrailKey)),
        mode: "onBlur",
        defaultValues: {
            handrail: null
        }
            ...
            <YStack id="Test" flex={1} style={{ alignItems: "start", justifyContent: "space-between", gap: 16 }}>
                <ScrollView width={"100%"} contentContainerStyle={{
                    ...
                    <YStack style={{ display: "flex", flexDirection: "column", alignItems: "flex-start", justifyContent: "flex-start", gap: 8 }}>
                        ...
                        <XStack width={"70%"} style={{ display: "flex", flexDirection: "row", alignItems: "center", justifyContent: "space-between", gap: 8 }}>
                            <Text style={{ fontSize: 14 }}>For 12 Feet</Text>
                            <Controller
                                control={control}
                                rules={{
                                    maxLength: 100,
                        ...
                        <XStack width={"70%"} style={{ display: "flex", flexDirection: "row", alignItems: "center", justifyContent: "space-between", gap: 8 }}>
                            <Text style={{ fontSize: 14 }}>For 15 Feet</Text>
                            <Controller
                                control={control}
                                rules={{
                                    maxLength: 100,
