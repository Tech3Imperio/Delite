...
import { getDotFinishCode } from "../../../../utils/dealer/getFinishCode";
import { QuantityInput } from "../../../../lib/QuantityInput";
import { createDotProtocol, Dot } from "../../../../types/product/base";
...
export const DotForm = ({ setOpen }: { setOpen: React.Dispatch<React.SetStateAction<boolean>> }) => {
    ...
    const {
        ...
        resolver: zodResolver(createDotProtocol(handrailKey)),
        mode: "onBlur",
        defaultValues: {
            handrail: null
        }
    ...
    useEffect(() => {
        setValue("baseProfileID", "E50");
        setValue("base.anchor.anchorID", "M12")
        setValue("base.anchor.anchorType", "M12")
                        ...
                        <XStack style={{ display: "flex", flexDirection: "row", alignItems: "flex-end", justifyContent: "flex-start", gap: 16 }}>
                            <Controller
                                ...
                                render={({ field: { onChange, onBlur, value } }) => (
                                    <SelectDotFinish onChange={onChange} onBlur={onBlur} value={value} />
                                )}
