...
import { createProProtocol, createSemiProProtocol, createSemiSmartProtocol, Pro, SemiPro, SemiSmart } from "../../../../types/product/base";
...
export const SemiSmartForm = ({ setOpen }: { setOpen: React.Dispatch<React.SetStateAction<boolean>> }) => {
    ...
    const {
        ...
        resolver: zodResolver(createSemiSmartProtocol(handrailKey)),
        mode: "onBlur",
        defaultValues: {
            handrail: null
        }
