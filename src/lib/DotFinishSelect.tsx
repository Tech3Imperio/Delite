...
import { DotFinishName, FinishName } from '../types/product/common'
import { Noop } from 'react-hook-form'

type SelectDotFinishProps<T> = {
    value: T
    onChange: (...event: any[]) => void,
    onBlur: Noop
}

export function SelectDotFinish<T extends string>({ onChange, onBlur, value }: SelectDotFinishProps<T>) {
    return (
...
type SelectDotFinishItemProps<T> = SelectProps & {
    value: T
    onChange: (...event: any[]) => void
    onBlur: Noop
}
export function SelectDemoItem<T>({ value,
    onChange,
    onBlur,
    ...props }: SelectDotFinishItemProps<T> & { trigger?: React.ReactNode }) {
...
const items = [
    { name: DotFinishName.BLACKGLOSSY },
    { name: DotFinishName.BLACKMATT },
    { name: DotFinishName.GOLDGLOSSY },
    { name: DotFinishName.GOLDMATT },
    { name: DotFinishName.ROSEGOLDGLOSSY },
    { name: DotFinishName.ROSEGOLDMATT },
    { name: DotFinishName.SSGLOSSY },
    { name: DotFinishName.SSMATT },
]